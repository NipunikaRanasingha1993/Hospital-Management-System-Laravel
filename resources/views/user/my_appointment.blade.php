...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" style=" background-color: #00D9A5; color:black" href="{{url('myappointment')}}">My Appointment</a>
            </li>
  ...
  <div align="center" style="padding: 70px">
    ...
    <table>
        ...
        <tr style="background-color:#00D9A5; color:black" align="center">
